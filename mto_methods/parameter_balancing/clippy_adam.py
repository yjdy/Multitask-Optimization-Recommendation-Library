import torch
import math
class ClippyAdam(torch.optim.Optimizer):
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group["params"]:
                ...
                _sigma = _compute_clippy_factor(p, exp_avg, denom,step_size, self.lambda_rel,self.lambda_abs)

                p_data_fp32.addcdiv_(_sigma*exp_avg, denom, value=-step_size)
